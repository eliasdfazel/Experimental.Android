...
import net.geeksempire.loadingspin.animation.AnimationUtils;
import net.geeksempire.loadingspin.animation.FloatProperty;
import net.geeksempire.loadingspin.animation.IntProperty;
